...
class ResNet(nn.Module):
    ...
    def __init__(self, input_channel, output_channel, block, layers):
        ...
        self.conv5 = nn.Conv2d(self.output_channel_block[3], 256, kernel_size=1, stride=1, padding=0, bias=False)
        self.maxpool4 = nn.MaxPool2d(kernel_size=2, stride=(2, 2), padding=(1, 1))
        self.maxpool5 = nn.MaxPool2d(kernel_size=2, stride=(2, 2), padding=0) 
        self.rescale = nn.Upsample(size=(3, 113), mode='bilinear', align_corners=False)

        drop_prob = 0.25
        self.dropblock = DropBlock2D(0.2, 7)
        # self.DropBlock2 = DropBlock2D(0.1, 7)
        # self.DropBlock3 = DropBlock2D(0.1, 7)
